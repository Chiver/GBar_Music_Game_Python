...
class RunGame(object):
    ...
    def redrawAll(self):
        ...
        font = pygame.font.SysFont('Current Score', 70)
        WHITE = (255, 255, 255)
        text = font.render(f'{self.score}', True, WHITE)
        textRect = text.get_rect(center=(self.screenWidth/2, self.screenHeight/2))
    ...
    def showSelectionMode(self):
        ...
        cwd = os.getcwd()
        self.musicFileName = cwd + '\\' + 'Audios' + '\\' + str(self.musicSelected) + '.wav'
...
class Player(object):
    def __init__(self, x, y):
        ...
        self.alpha = 3*math.pi/180 # angular acceleration
        self.omega = 0 # angular speed
        self.theta = 0 # swiped angle

    def rotate(self, direction=None):
        maxOmega = 12*math.pi/180
    ...
    def draw(self, screen):
        ...
        (self.x1, self.y1), (self.x2, self.y2), 5) # 7 is width
